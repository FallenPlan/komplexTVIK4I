...
//        Box2D.init();
            ...
            setScreen(new MainMenuScreen(test2));

//        bird = new Bird("testCharacter.jpg", this, 10, 10);
            bird = new Bird("bird01_3.png", test2, -180, 10);
            pig = new Pig("pig01.png", test2, 75, 10);
            pig2 = new Pig("pig01.png", test2, 75, 130);
            pig3 = new Pig("pig01.png", test2, -20, 10);
            pig4 = new Pig("pig01.png", test2, -20, 130);

            block = new Block("block3.png", test2,50,30);
            block2 = new Block("block3.png", test2,100,30);
            block3 = new Block("block3.png", test2,50,140);
            block4 = new Block("block3.png", test2,100,140);
            blockH3 = new BlockH("block3.png", test2,-14,100);
            blockH4 = new BlockH("block3.png", test2,76,100);

            block5 = new Block("block3.png", test2,-40,30);
            block6 = new Block("block3.png", test2,10,30);
            block7 = new Block("block3.png", test2,-40,140);
            block8 = new Block("block3.png", test2,10,140);
            blockH1 = new BlockH("block3.png", test2,-14,180);
            blockH2 = new BlockH("block3.png", test2,76,180);
