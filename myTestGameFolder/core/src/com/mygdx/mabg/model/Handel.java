...
//    }
    ...
    public void applyImpulse() {
        if (ImpMath.equal(A.invMass + B.invMass, 0)) {
    ...
    public void positionalCorrection() {
        float correction = StrictMath.max(penetration - ImpMath.PENETRATION_ALLOWANCE, 0.0f) / (A.invMass + B.invMass) * ImpMath.PENETRATION_CORRETION;
